...
def plot_separate_masks(masks, mask_quality, point_coords, bboxes):
    ...
    for i, mask in enumerate(masks):
        ...
        colored_mask_with_bbox = draw_bounding_boxes(colored_mask, [bboxes[i]] if bboxes is not None else None, thickness=8)
...
def plot_masks_on_image(image, masks, bboxes=None, bboxes_on_overlay=True, mask_quality=None, point_coords=None, alpha=0.5):
    """
